...
## MODIFICAÇÕES MOUSE - Adicionadas em 24/08/2024 - by A3. ;P
define config.mouse = {'default': [('gui/pointer_mouse.png', 0, 0)]}
...
define build.name = "AprendaLibras"
...
define config.save_directory = "AprendaLibras-1724270618"
...
init python:
    ...
    #LINHA ADICIONADA PARA TRANSFORMAR O .EXE EM UM ARQUIVO SOLO - A3
